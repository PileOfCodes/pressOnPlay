<template>
    <div class="relative w-full " ref="container">
        <div style="font-weight: 900" class="lg:hidden my-8 text-center mx-auto w-[400px] sm:w-[380px] md:w-[800px] text-[60px] sm:text-[90px] md:text-[110px]">Please don’t be quiet</div>
        <div class="lg:hidden my-12 px-5 flex items-center justify-center">
            <div class="w-full h-[250px] sm:h-[350px] md:h-[420px] mx-auto">
                <NuxtImg src="/claireDorn.jpg" class="w-full h-full object-cover rounded-xl" alt="girl"/>
            </div>
        </div>
