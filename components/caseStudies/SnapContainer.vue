<template>
    <div class="Perspective Perspective--shadows">
        <div class="Perspective__container">
            <div :class="props.color" class="Perspective__container__face Perspective__container__face--front">
                <slot name="front"></slot>
            </div>
            <div :class="props.color" class="Perspective__container__face Perspective__container__face--top">
                <slot name="top"></slot>
            </div>
...
.Perspective--top>.Perspective__container {
    transform: translateZ(-120px) rotateX(-90.1deg);
}
...
.Perspective__container__face--top {
    transform: rotateX(90.1deg) translateZ(120px);
}
.Perspective__container__face--back {
    transform: translateZ(-120px) rotateY(-180deg) rotate(180deg);
}
.Perspective__container__face--bottom {
    transform: rotateX(-90.1deg) translateZ(120px);
}
