<template>
    <div class="Perspective Perspective--shadows" :class="isMounted ? 'Perspective--top' : 'Perspective--front'">
        <div class="Perspective__container" :class="props.delay">
...
const props = defineProps(['color', 'delay'])
